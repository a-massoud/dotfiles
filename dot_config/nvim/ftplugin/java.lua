...
vim.api.nvim_set_keymap("n", "<leader>djf", "<cmd>lua require'jdtls'.test_class()<cr>", { noremap = true })
vim.api.nvim_set_keymap("n", "<leader>djm", "<cmd>lua require'jdtls'.test_nearest_method()<cr>", { noremap = true })
